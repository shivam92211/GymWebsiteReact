...
export default class A5ClassSectioCompo extends Component {
    render() {
        return (
            <div>
                {/* <!-- CLASS --> */}
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                                <div className="class-thumb">
                                    <img src="images/class/phone.jpg" className="img-fluid" alt="Class" />
                            ...
                            <div className="mt-5 mt-lg-0 mt-md-0 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="500">
                                <div className="class-thumb">
                                    <img src="images/class/switch.jpg" className="img-fluid" alt="Class" />
                            ...
                            <div className="mt-5 mt-lg-0 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="600">
                                <div className="class-thumb">
                                    <img src="images/class/connection.jpg" className="img-fluid" alt="Class" />
