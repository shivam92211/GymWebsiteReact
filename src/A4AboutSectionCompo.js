...
export default class A4AboutSectionCompo extends Component {
    render() {
        return (
            <div>
                {/* <!-- ABOUT --> */}
                        ...
                        <div className="row">
                            ...
                            <div className="mt-lg-5 mb-lg-0 mb-4 col-lg-5 col-md-10 mx-auto col-12">
                                ...
                                <p data-aos="fade-up" data-aos-delay="500">If you have any question regarding <a rel="nofollow"
                                    href="https://www.tooplate.com/view/2119-gymso-fitness" target="_parent">Gymso Fitness HTML
                                    template</a>, you can <a rel="nofollow" href="https://www.tooplate.com/contact"
                                        target="_parent">contact Tooplate</a> immediately. Thank you.
                                </p>
                            ...
                            <div className="mr-lg-auto mt-5 mt-lg-0 mt-md-0 col-lg-3 col-md-6 col-12" data-aos="fade-up"
                                data-aos-delay="800">
                                <div className="team-thumb">
